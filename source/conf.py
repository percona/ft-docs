# -*- coding: utf-8 -*-
#
# Fractal Tree documentation build configuration file, created by
# sphinx-quickstart on Fri May 30 09:00:46 2015.
#
...
project = u'Fractal Tree documentation'
...
html_title = ' Fractal Tree Documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Fractal Tree Documentation'
...
htmlhelp_basename = 'FractalTreedoc'
...
latex_documents = [
  ('index', 'FractalTree.tex', u'Fractal Tree Documentation',
...
man_pages = [
    ('index', 'fractaltree', u'Fractal Tree Documentation',
